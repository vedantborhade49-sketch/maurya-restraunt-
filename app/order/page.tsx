...
import { ShoppingBag, ChevronRight, Phone, MapPin, CreditCard, ArrowLeft, Loader2 } from "lucide-react";
...
export default function OrderPage() {
  const { items, getSubtotal, clearTable, getItemCount } = useTableStore();
  ...
  const onSubmit = async (data: CheckoutFormValues) => {
    ...
    try {
      ...
      if (newOrder) {
        // 2. Generate WhatsApp message (Phase 13 layout)
