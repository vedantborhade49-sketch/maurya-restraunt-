  ...
  return (
    <section ref={containerRef} className="relative w-full overflow-hidden content-visibility-auto">
      ...
      <div className="relative w-full min-h-[150vh] flex flex-col justify-start items-center py-20 px-6 md:px-12">
        ...
        <div className="relative w-full max-w-[1200px] z-10 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div ref={setItemRef(0)} className="col-span-2 md:col-span-2 aspect-[4/3] relative bg-[#fdfbf7] p-3 md:p-5 shadow-[0_5px_15px_rgba(0,0,0,0.08)] transform rotate-1">
            ...
            <div className="relative w-full h-full overflow-hidden border border-black/10">
              <Image src="https://images.unsplash.com/photo-1550966871-3ed3cdb5ed0c?q=80&w=800" alt="Archive 1" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover grayscale contrast-125" decoding="async" loading="lazy" />
            </div>
          ...
          <div ref={setItemRef(1)} className="col-span-1 md:col-span-1 aspect-square relative bg-[#fdfbf7] p-2 md:p-3 shadow-[0_5px_15px_rgba(0,0,0,0.08)] transform -rotate-2 mt-12">
             <div className="relative w-full h-full overflow-hidden border border-black/10">
              <Image src="/editorial-food-4.png" alt="Archive 2" fill sizes="(max-width: 768px) 50vw, 25vw" className="object-cover sepia-[0.3]" decoding="async" loading="lazy" />
            </div>
          </div>
          ...
          <div ref={setItemRef(2)} className="col-span-1 md:col-span-1 aspect-[3/4] relative bg-[#fdfbf7] p-2 md:p-3 shadow-[0_5px_15px_rgba(0,0,0,0.08)] transform rotate-3">
             <div className="relative w-full h-full overflow-hidden border border-black/10">
              <Image src="/editorial-entrance.png" alt="Archive 3" fill sizes="(max-width: 768px) 50vw, 25vw" className="object-cover grayscale" decoding="async" loading="lazy" />
            </div>
          </div>
          ...
          {/* Contact Sheet Item 4 */}
          <div ref={setItemRef(4)} className="col-span-2 md:col-span-3 aspect-[21/9] relative bg-[#fdfbf7] p-3 md:p-4 shadow-[0_5px_15px_rgba(0,0,0,0.08)] transform rotate-1 mt-8 md:mt-0">
             {/* Binder Clip */}
             ...
             <div className="relative w-full h-full overflow-hidden border border-black/10">
              <Image src="/editorial-food-1.png" alt="Archive 4" fill sizes="(max-width: 768px) 100vw, 75vw" className="object-cover grayscale sepia-[0.2]" decoding="async" loading="lazy" />
            </div>
